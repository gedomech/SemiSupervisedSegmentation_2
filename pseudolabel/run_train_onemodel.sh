...
#
CUDA_VISIBLE_DEVICES=0 python train_onemodel.py --save_dir semi_without_labeleddata_last --run_semi True --semi_train__update_labeled=False --model_path runs/pretrain_lr_0.01/best.pth --semi_train__lr=0.0001 &
...
CUDA_VISIBLE_DEVICES=0 python train_onemodel.py --save_dir semi_batch_8_last --run_semi True  --model_path runs/pretrain_lr_0.01/last.pth --batch_size 8 --semi_train__lr=0.0001

CUDA_VISIBLE_DEVICES=0 python train_onemodel.py --save_dir semi_batch_16_last --run_semi True  --model_path runs/pretrain_lr_0.01/last.pth --batch_size 16 --semi_train__lr=0.0001
